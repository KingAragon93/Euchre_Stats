...
GAME_OF_THRONES = {
    ...
    'celebration_partnership_header': '🤝 Sworn Partnerships',
    'celebration_partnership_caption': 'Sagas these sworn brothers have fought together — regardless of who else stood beside them.',
    'celebration_partnership_total': '{n} sagas together',
    'celebration_partnership_record': '{wins} won · {losses} lost · {pct}% win rate',
...
STANDARD = {
    ...
    'celebration_partnership_header': '🤝 Partnership Records',
    'celebration_partnership_caption': "Games these players have played as teammates — regardless of who else was on the team.",
    'celebration_partnership_total': '{n} games together',
    'celebration_partnership_record': '{wins} W · {losses} L · {pct}% win rate',
